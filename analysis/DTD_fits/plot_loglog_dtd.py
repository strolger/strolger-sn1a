...
ax2.errorbar(data[idx][:,0], data[idx][:,3]*msc,
            ...
            fmt='o', color='k', mfc='1.0', mec='C3', label='Cluster Rates')
pwrl = (-1.39,1.0)
...
ax2.errorbar(data[idx][1:,0], data[idx][1:,3]*msc,
            ...
            fmt='o', color='k', mfc='1.0', mec='C0', label='Field Rates')
ax2.errorbar(data[idx][0,0], data[idx][0,3]*msc,
             xerr=data[idx][0,2],
             yerr=0.05,#data[idx][0,5]*msc,#,data[idx][:,5]*msc],
             lolims=data[idx][0,5]*msc,
             fmt='o', color='k', mfc='1.0', marker='^', ms=10, mec='C0', label='LMC & SMC limit')
pwrl = (-1.10,1.0)
