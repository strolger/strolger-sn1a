...
The various SN~Ia volumetric rate measurements are shown in Table~\ref{tab:sn1a_rates} and Figure~\ref{fig:sn1a_rates}. For illustration purposes through out this manuscript, we bin the rate data into 8 quantiles of nearly equal number of measures, and present those binned measures, weighted by reported statistical uncertainties only, as also shown in Figure~\ref{fig:sn1a_rates} and in Table~\ref{tab:sn1a_bin}. None of the analysis presented herein is performed on the binned measures, rather directly on the rate values themselves.
