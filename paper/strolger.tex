...
%\noindent \textcolor{red}{Talk about the expected delay-time distribution, values from Graur and Maoz, inability to probe beyond turnover at `SN high noon', around $z\sim1$}. 
